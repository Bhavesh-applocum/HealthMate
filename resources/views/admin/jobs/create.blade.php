...
<div class="box" id="ShowJob">
    <div class="form-design">
        ...
        {{ Form::open(['method'=>'POST','route'=>['admin.jobs.create'], 'files'=>true]) }}
        <div class="row m-4">
            <div class="col-6">
                <div class="form-box">
                    ...
                    <div class="input-group my-3 d-flex flex-row justify-content-between align-items-center">
                        ...
                        <div class="input-wrapper select-wrapper flex-grow-1">
                            <select name="role" class="single-select2" id="" data-placeholder="Select Category">
                                <option value=""></option>
            ...
            <div class="col-6">
                <div class="form-box">
                    ...
                    <div class="input-group my-3 d-flex flex-row justify-content-between align-items-center">
                        ...
                        <div class="input-wrapper select-wrapper flex-grow-1">
                            <select name="parking" id="ClientDrop" class="single-select2" data-placeholder="Select Client">
                                <option value=""></option>
                                @foreach ($data['AllClient'] as $key => $client )
                                <option value="{{ $client['id'] }}" data-id="{{ $client['id'] }}">{{ $client['practice_name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="ClientInfo">
                        <div class="profile-pic-div m-auto my-5">
                            <img class="img-profile rounded-circle shadow-4-strong client_profile" src="/{{ 'images/user.svg' }}" style="width:100px;height:100px;object-fit:cover;" id="show">
                        ...
                        <div class="input-group d-flex flex-row justify-content-between align-items-center my-4">
                            ...
                            <div class="input-wrapper flex-grow-1">
                                {{ Form::email('client_email', null, ['class'=>'form-control clientEmail', 'id'=>'clientEmail', 'readonly']) }}
                            </div>
                        </div>
                        <div class="input-group d-flex flex-row justify-content-between align-items-center my-4">
                            <label for="" class="mb-0 mr-2" style="width:135px">Phone</label>
                            <div class="input-wrapper flex-grow-1">
                                {{ Form::text('client_phone', null, ['class'=>'form-control clientPhone', 'id'=>'clientPhone', 'readonly']) }}
                            </div>
                        </div>
                    </div>
                </div>
